from sqlalchemy import Column, BigInteger, Numeric, Integer, TIMESTAMP, ForeignKey, UniqueConstraint, CheckConstraint
...
class Cart(Base):
    ...
    customer_id = Column(BigInteger, ForeignKey("customer.id", ondelete="CASCADE"), unique=True, nullable=False)
